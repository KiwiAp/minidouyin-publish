...
require (
	...
	github.com/hertz-contrib/logger/zap v0.0.0-20230206071608-2de215a9fd50
	github.com/kitex-contrib/obs-opentelemetry/logging/zap v0.0.0-20230215024021-be92bf60dfc7
